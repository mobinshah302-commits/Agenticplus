...
CREATE TABLE IF NOT EXISTS users (
    ...
    tools_enabled TEXT DEFAULT '{"web_search":true,"code_exec":true,"image_gen":true,"video_gen":true,"browser":true}',
...
class DB:
    ...
    async def get_tools_enabled(self, user_id: int) -> dict:
        ...
        try:
            return json.loads(u["tools_enabled"])
        except Exception:
            return {"web_search": True, "code_exec": True, "image_gen": True, "video_gen": True, "browser": True}
